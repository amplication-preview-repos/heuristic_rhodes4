...
import { YouTubeChannelFindManyArgs } from "../../youTubeChannel/base/YouTubeChannelFindManyArgs";
...
export class UserControllerBase {
  ...
  async findYouTubeChannels(
    ...
    const query = plainToClass(YouTubeChannelFindManyArgs, request.query);
    const results = await this.service.findYouTubeChannels(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/youTubeChannels")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectYouTubeChannels(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: YouTubeChannelWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      youTubeChannels: {
        connect: body,
  ...
  @common.Patch("/:id/youTubeChannels")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateYouTubeChannels(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: YouTubeChannelWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/youTubeChannels")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectYouTubeChannels(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: YouTubeChannelWhereUniqueInput[]
  ): Promise<void> {
    const data = {
