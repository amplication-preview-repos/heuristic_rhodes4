...
@InputType()
class YouTubeChannelCreateNestedManyWithoutUsersInput {
...
export { YouTubeChannelCreateNestedManyWithoutUsersInput as YouTubeChannelCreateNestedManyWithoutUsersInput };
